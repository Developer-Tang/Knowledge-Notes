...
<img src="images/GuavaCache原理分析与最佳实践/202109061416685.webp" alt="图片" style="zoom:50%;" />
...
<img src="images/GuavaCache原理分析与最佳实践/202109061419299.webp" alt="图片" style="zoom:67%;" />

> 核心代码都在 LocalCache 这个文件中，并且通过这个继承关系可以看出 Guava Cache 的本质就是 ConcurrentMap。

<img src="images/GuavaCache原理分析与最佳实践/640.webp" alt="图片" style="zoom: 80%;" />

> 在看源码之前先理一下流程，先理清思路。如果想直接看源码理解流程可以先跳过这张图 ~

<img src="images/GuavaCache原理分析与最佳实践/640.webp" alt="图片" style="zoom:67%;" />
