...
![image-20210923175246491](images/GuavaCache原理分析与最佳实践/image-20210923175246491.png)
...
![image-20210923175406296](images/GuavaCache原理分析与最佳实践/image-20210923175406296.png)

> 核心代码都在 LocalCache 这个文件中，并且通过这个继承关系可以看出 Guava Cache 的本质就是 ConcurrentMap。

![image-20210923175507239](images/GuavaCache原理分析与最佳实践/image-20210923175507239.png)

> 在看源码之前先理一下流程，先理清思路。如果想直接看源码理解流程可以先跳过这张图 ~

![image-20210923175650921](images/GuavaCache原理分析与最佳实践/image-20210923175650921.png)
